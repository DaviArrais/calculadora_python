...
Label(LabelFrame_imc, textvariable=texto).place(x=50, y=50, width=300, height=40)

#Frame_imc_indice=Frame(LabelFrame_imc, borderwidth=1, relief="solid" ).place(x=290,y=313, width=120, height=80)
#valor_imc=Label(Frame_imc_indice, text="Valor imc", textvariable=imc)
#valor_imc.place(x=20, y=20, width=20, height=20)
